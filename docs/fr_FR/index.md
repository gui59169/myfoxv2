...
- Derniers evenements(historique sur 1 an)
	...
	*- de type "security"
	*- de type "diagnosis"
- Dernier evenement(historique sur 1 an) - Tout type confondu
* S'il n'y a pas d'evenement sur 1 an, la commande retourne : Aucun *
